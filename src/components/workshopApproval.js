    ...
    render(){
        return (
            <div className="container ">
                ...
                <span> <i> This page shows workshop details submissions </i> </span><br></br>
                <span> <i> Click the review submission button to view the submission and update its status </i> </span><br></br>
                <br></br>
